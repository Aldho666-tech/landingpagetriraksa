      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
        ...
        >
          ...
          <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="mt-4 flex items-center justify-center gap-2 bg-[#8dc63f] hover:bg-[#7cb036] text-white font-semibold py-3 px-6 rounded-md transition-colors w-fit shadow-md shadow-[#8dc63f]/20"
            >
              Download Brochure
